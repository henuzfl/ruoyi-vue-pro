...
@Schema(description = "管理后台 - 订单表 - SAP订单信息 Response VO")
@Data
...
public class OrderRespVO {
    ...
    @ExcelProperty("创建者/输入者")
    private String createdBy;

    @Schema(description = "系统状态(如REL PCNF等)", example = "1")
    @ExcelProperty("系统状态(如REL PCNF等)")
