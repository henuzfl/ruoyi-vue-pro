...
public class MaterialKittingToolServiceImpl implements MaterialKittingToolService {
    ...
    @Override
    public List<MaterialKittingToolDO> selectMasterKittingToolForExport(MaterialKittingToolPageReqVO exportReqVO) {
        ...
        // 方法1：创建新的查询参数，忽略分页
        MaterialKittingToolPageReqVO queryParams = new MaterialKittingToolPageReqVO();
        ...
        // 调用分页方法
        PageResult<MaterialKittingToolDO> pageResult = selectMaterialKittingToolByParams(queryParams);
    ...
    @Override
    public PageResult<MaterialKittingToolDO> selectCalculateKittingToolByParams(MaterialKittingToolPageReqVO pageReqVO) {
        // 调试：检查日期参数
        log.info("=== 参数明细调试开始 ===");
        log.info("接收到的 scheduledDate 数组: {}", Arrays.toString(pageReqVO.getScheduledDate()));
        ...
        // 直接传入 VO 对象
        List<MaterialKittingToolDO> list = materialKittingToolMapper.selectCalculateKittingToolByParams(pageReqVO);
    ...
    @Override
    public List<MaterialKittingToolDO> selectCalculateKittingToolForExport(MaterialKittingToolPageReqVO exportReqVO) {
        log.info("导出查询参数: scheduledDate={}, productionOrderNo={}",
                Arrays.toString(exportReqVO.getScheduledDate()),
                exportReqVO.getProductionOrderNo());
        ...
        // 调用分页方法
        PageResult<MaterialKittingToolDO> pageResult = selectCalculateKittingToolByParams(queryParams);
