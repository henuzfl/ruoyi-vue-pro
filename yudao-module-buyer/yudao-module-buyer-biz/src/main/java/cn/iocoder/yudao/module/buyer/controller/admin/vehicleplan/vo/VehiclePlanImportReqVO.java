...
@Schema(description = "管理后台 - 买家车辆营销计划 Excel 导入 VO")
@Data
public class VehiclePlanImportReqVO {
    ...
    @Schema(description = "裸机订单号", requiredMode = Schema.RequiredMode.REQUIRED)
    private String bareMachineOrderNo;

    @Schema(description = "行驶单元订单号")
    private String drivingUnitOrderNo;

    @Schema(description = "内外贸（内贸/外贸）")
