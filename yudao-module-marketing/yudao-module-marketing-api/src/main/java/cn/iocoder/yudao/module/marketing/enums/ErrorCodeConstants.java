...
public interface ErrorCodeConstants {
    ...
    // ========== 计划模块 1-002-029-000 ==========
    ErrorCode AERIAL_BOOM_WPLAN_NOT_EXISTS = new ErrorCode(1_004_001_000, "高机臂式周计划不存在");
    ErrorCode AERIAL_BOOM_DPLAN_NOT_EXISTS = new ErrorCode(1_004_002_000, "高机臂式日计划不存在");
    ErrorCode AERIAL_BOOM_BOM_NOT_EXISTS = new ErrorCode(1_004_003_000, "高机臂式/剪叉BOM物料清单不存在");
    ErrorCode SCISSOR_LIFT_WPLAN_NOT_EXISTS = new ErrorCode(1_004_004_000, "高机剪叉周计划不存在");
    ErrorCode SCISSOR_LIFT_DPLAN_NOT_EXISTS = new ErrorCode(1_004_005_000, "高机剪叉日计划不存在");
    ErrorCode CONCRETE_PLAN_NOT_EXISTS = new ErrorCode(1_004_006_000, "混凝土计划需求不存在");
    ErrorCode CONCRETE_BOM_NOT_EXISTS = new ErrorCode(1_004_007_000, "混凝土BOM不存在");
    ErrorCode ASM_REQUIREMENT_NOT_EXISTS = new ErrorCode(1_004_008_000, "营销总成需求不存在");
}