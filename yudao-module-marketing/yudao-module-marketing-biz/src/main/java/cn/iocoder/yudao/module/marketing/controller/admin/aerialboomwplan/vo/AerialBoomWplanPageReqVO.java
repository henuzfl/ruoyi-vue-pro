package cn.iocoder.yudao.module.marketing.controller.admin.aerialboomwplan.vo;
...
@Schema(description = "管理后台 - 高机臂式周计划分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class AerialBoomWplanPageReqVO extends PageParam {
